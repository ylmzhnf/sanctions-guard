...
export class AuditController {
  ...
  @Get('logs')
  @ApiOperation({
    summary: 'Get organization audit logs with pagination and search',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Search by action, user, or query name',
  })
  async getLogs(
    ...
    const result = await this.auditService.getOrgLogs(
      orgId,
      page,
      limit,
      search,
  ...
  @Get('verify/:id')
  @ApiOperation({
    summary: 'Verify cryptographic integrity of a specific audit log',
  })
